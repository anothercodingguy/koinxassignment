export interface GainLossDetail {
  balance: number;
  gain: number;
}
...
// Mock delay to simulate network request latency
...
export const HOLDINGS_DATA: Holding[] = [
  ...
  },
  {
    ...
    "averageBuyPrice": 1.637624055112482e-05,
    "stcg": {
  ...
  },
  {
    ...
    "totalHolding": 4.7233224826389e-05,
    "averageBuyPrice": 9.172984515948809,
    "stcg": {
      "balance": 4.7233224826389e-05,
  ...
  },
  {
    ...
    "totalHolding": 6.442993445432421e-07,
    "averageBuyPrice": 0.453964789704584,
    "stcg": {
      "balance": 6.442993445432421e-07,
      "gain": -2.3205780373028534e-07
    },
    "ltcg": {
      "balance": 0,
      "gain": 0
  ...
  },
  {
    ...
    "logo": "https://koinx-statics.s3.ap-south-1.amazonaws.com/currencies/DefaultCoin.svg",
    "currentPrice": 8.65643e-07,
    "totalHolding": 8.861,
    "averageBuyPrice": 8.531798889329416e-07,
    "stcg": {
      "balance": 8.861,
      "gain": 1.1043562716520403e-07
    },
    "ltcg": {
      "balance": 0,
      "gain": 0
...
export const CAPITAL_GAINS_DATA: { capitalGains: CapitalGains } = {
  "capitalGains": {
    "stcg": {
      "profits": 70200.88,
      "losses": 1548.53
...
export const fetchCapitalGains = (): Promise<CapitalGains> => {
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve(CAPITAL_GAINS_DATA.capitalGains);
    }, MOCK_DELAY);
  });
};
